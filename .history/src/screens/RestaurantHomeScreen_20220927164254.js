          ...
          <View style={styles.view2}>
            <View style= {styles.view3}>
              ...
              <View style= {styles.view4}>
                ...
                <Text style= {styles.text6}>{restauratsData[id].farAway} km 떨어짐 </Text>
              </View>
            ...
            <View style= {styles.view8}>
              <Text style={styles.text9}>배달시</Text>
              <View style={styles.view7}>
                <Text style={styles.text9}>{restauratsData[id].collectTime}</Text>
