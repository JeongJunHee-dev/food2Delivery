...
export default class PreferenceScreen extends Component {
    ...
    constructor(props) {
        ...
        counter:menuDetailedData[this.props.route.params.index].counter; //카운터 걸때 데이터 받고 주고 설정
    }
    ...
    return (
      <View style = {styles.container}>
            ...
            <View>
                { this.state.preference.map(item=><View key= {item.id}>
                    <View style={styles.view7}>
                        ...
                        {this.state.required[this.state.preference.indexOf(item)] &&
                            <View style = {styles.view9}>
                                <Text style= {styles.text7}>{this.state.minimum_quantity[this.state.preference.indexOf(item)]} 요청됨</Text>
                            </View>
                    ...
                    <View style = {styles.view10}>
                        ...
                        <TouchableOpacity key={items.id} //터치 할때 아이디 값(데이터.js) 에 클릭시 값 설정
                            onPress={()=> {
                                const id = this.preference.indexOf(item)

                                if(this.state.minimum_quantity[id] !== null){
                                    const check = item.filter(items => items.minimum_quantity[id]);
                                    ...
                                    <View style={styles.view19}>
                                        ...
                                        <View style={styles.view6}>
                                            <CheckBox 
                                                ...
                                                checked = {items.checked} // 아이템 체크시 값 전달
                                                checkedColor = {colors.buttons}
                                            />
        ...
        <View style = {styles.view13}>
            <Text style={styles.text11}>총 수량</Text>
        </View>
        ...
        <View style={styles.view17}>
            <View style={styles.view18}>
                <Text style ={styles.text10}> 총 가격 6200원에 카트담기 </Text>
            </View>
        </View>
