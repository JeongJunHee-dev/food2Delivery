                ...
                {(props)=>(
                    <View style= {styles.view2}>
                        ...
                        <View style={styles.view15}>
                            ...
                            <Text style={styles.text3}>회원 가입 및 계정생성시 </Text>

                            <View style={styles.view16}>
                                <Text style={styles.text3}>동의 부분은 </Text>
                                <Text style ={styles.text4}>표준약관</Text>
                                <Text style = {styles.text3}> 의거 처리됨에 </Text>
                            </View>

                            <Text style ={styles.text4}> 가입을 하오니 확인바랍니다.</Text>
