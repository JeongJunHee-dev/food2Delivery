    ...
    async function ignUp(values){
        ...
        try{
            ...
            if(error.code === 'auth/email-already-in-use'){
                Alert.alert('이메일이 유효하지 있습니다');
            }
            if(error.code === 'auth/invailid-email'){
                Alert.alert('이메일이 등록되어 있습니다.');
            }else{
    ...
    <View style = {styles.container}>
      ...
      <ScrollView keyboardShouldPersistTaps = "always">
                ...
                {(props)=>(
                    <View style= {styles.view2}>
                        ...
                        <View style={styles.view15}>
                            ...
                            <Text style={styles.text3}>회원 가입 및 계정생성시 동의 부분은 </Text>

                            <View style={styles.view16}>
                                <Text style ={styles.text4}>표준약관</Text>
                                <Text style = {styles.text3}> 의거 처리됨에 확인바랍니다.</Text>
                            </View>
            ...
            <View style={styles.view18}>
                <Text style={styles.text5}>혹은</Text>
            </View>

            <View style= {styles.view19}>
                {/*<View style={styles.view20}>
                    <Text style={styles.text6}>계정이 있습니꽈?</Text>
                </View>*/}
