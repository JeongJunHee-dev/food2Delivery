...
export const menuDetailedData =[
    { 
      ...
      preferenceTitle:["딥소스 2개 선택","음료는 1개맛 가능", "음료를 2개맛 가능","추가할 음식이 있습니까?","더 필요한거 있으신가요?"  ],
      preferenceData: [
  ...
  
    {
      ...
      details:"100% 순 쇠고기 패티 두 장에 특별한 소스.세계인의 입맛을 사로 잡은 대명사.",
      preferenceTitle:["딥소스 2개 선택","음료는 1개맛 가능", "음료를 2개맛 가능","추가할 음식이 있습니까?","더 필요한거 있으신가요?"   ],
      preferenceData: [
  ...
  
    {
      ...
      details:"100% 창녕 햇마늘이 들어간 마늘 토핑과 마늘 아이올리 소스,순 쇠고기 패티 2장의 맛!",
      preferenceTitle:["딥소스 2개 선택","음료는 1개맛 가능", "음료를 2개맛 가능","추가할 음식이 있습니까?","더 필요한거 있으신가요?"   ],
      preferenceData: [
    ...
    { 
      ...
      meal:"더블 쿼터파운더® 치즈", 
      price:6500,
      image:"https://www.mcdonalds.co.kr/upload/product/pcfile/1583727501907.png",
      details:"00% 순 쇠고기 패티 두 장과 치즈 두 장이 입안 가득 완벽하게 조화되는 놀라운 맛",
    ...
    { 
      meal:"1955® 버거",
      price:6000,
      image:"https://www.mcdonalds.co.kr/upload/product/pcfile/1599119647587.png",
      details:"맥도날드가 처음 생긴 1955년의 맛을 담은 영원한 오리지널 1955 버거",
      preferenceTitle:["딥소스 2개 선택","음료는 1개맛 가능", "음료를 2개맛 가능","추가할 음식이 있습니까?","더 필요한거 있으신가요?"   ],
      preferenceData: [
