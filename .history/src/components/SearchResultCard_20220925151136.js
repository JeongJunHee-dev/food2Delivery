...
const SearchResultCard = ({ OnPressRestaurantCard, restaurantName, deliveryAvailabe,
                            discountAvailable, discountPercent, numberOfReview, businessAddress,
                            farAway, averageReview, images, productData}) => {
      ...
      <View style ={styles.view1}>
            ...
            <View style = {{height:150}}>
                ...
                <View style ={styles.image}>
                    ...
                    <Text style ={styles.text2}> {numberOfReview} 리뷰</Text>
            ...
            <View style = {styles.view3}>
                ...
                <View style = {{flexDirection:"row"}}>
                    ...
                    <View style = {styles.view4}>
                        ...
                        <Text style= {styles.view5}>{farAway} 분</Text>
                    </View>
